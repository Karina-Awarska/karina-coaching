    ...
    <div className={styles.home}>
        ...
        <section className={styles.welcomeSection}>
          <div className={styles.welcomeSectionContent}>
            <div className={styles.welcomeSectionText}>
              <p>
                <span>Zmiana zaczyna się od Ciebie.</span> Jestem tu aby
                wspierać Cię w życiowych i zawodowych transformacjach. Ważne
                jest dla mnie holistyczne podejście do człowieka i jego zasobów.{" "}
                <span>Dbanie o dobrostan.</span>
              </p>
              <p>
                Będę Cię inspirować do realizacji ambitnych celów. Zbudujemy
                razem nową mapę mentalną aby z odwagą i lekkością zmienić swoje
                życie na bardziej wartościowe.
              </p>
            </div>
            <Image
              src={Karina}
      ...
      <LayoutComponent>
        <section className={styles.quoteSection}>
          ...
          <h2>
            Nie możemy stać się tym, kim chcemy być, pozostając tym, kim
            jesteśmy…
          </h2>
        </section>
      </LayoutComponent>
                ...
                <div className={styles.programContent}>
                  ...
                  <ul className={styles.programUl}>
                    ...
                    <li>
                      ...
                      Twój rozwój, i skupisz się na tym, na co masz realny
                      wpływ.
                    </li>
                    <li>
                      <div className={styles.iconWrapper}>
          ...
          <div className={styles.aboutMeSectionContext}>
            <div className={styles.aboutMeSectionText}>
              ...
              <ul>
                ...
                <li>
                  <span>Coaching w Grupie Set</span>, dał mi dobry fundament
                  pracy coachingowej, aktywnego słuchania, trafnego zadawania
                  pytań i pracy głębokiej z klientem w akceptacji i zaufaniu;
                </li>
                <li>
                  Studia podyplomowe z{" "}
                  <span>
                    Psychologii pozytywnej w Szkole Wyższej Psychologii
                    Społecznej SWPS
                  </span>
                  , pogłębiły moją wiedzę psychologiczną, poznałam badania
                  naukowe na temat dobrostanu i interwencji pozytywnych
                </li>
                <li>
                  <span>
                  ...
                  , pogłębił moją pracę coachingową, dał mi skuteczną strukturę
                  w pracy z klientem przy zmianie i/lub przewartościowaniu
                  ścieżki zawodowej;
                </li>
                <li>
